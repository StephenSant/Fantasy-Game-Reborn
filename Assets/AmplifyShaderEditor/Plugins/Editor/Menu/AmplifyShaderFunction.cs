...
public class AmplifyShaderFunction : ScriptableObject
{
	...
	public string CustomNodeCategory
	{
		get
		{
			...
			{
				return AmplifyShaderEditor.UIUtils.CategoryPresets[ (int)m_nodeCategory ];
	...
	public void ResetDirectivesOrigin()
	{
		...
		if( AmplifyShaderEditor.UIUtils.CurrentShaderVersion() < 17101 )
		{
...
public class ShaderFunctionDetector : AssetPostprocessor
{
	...
	{
		if( AmplifyShaderEditor.UIUtils.CurrentWindow == null )
			return;
      ...
      AmplifyShaderEditor.UIUtils.CurrentWindow.LateRefreshAvailableNodes();
		}
	}
}
